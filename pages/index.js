      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-b-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-dashed border-blue-300 rounded-xl p-4 md:p-6 bg-gradient-to-br from-blue-50/80 to-indigo-50/80 hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 group">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                {/* Icon */}
                <div className="bg-blue-100 rounded-lg p-2 md:p-3 group-hover:bg-blue-200 transition-colors duration-300 mx-auto sm:mx-0">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-sm">
                    ...
                    <div className="flex gap-2">
                      <a 
                        href="tel:0941108117"
                        className="bg-blue-500 hover:bg-blue-600 text-white px-2 md:px-3 py-1 rounded-lg transition-colors font-medium text-xs md:text-sm whitespace-nowrap"
                      >
                        0941108117
                      </a>
                      <a 
