      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-xl rounded-b-2xl">
          ...
          <div className="p-6 md:p-8">
            ...
            {/* Notary Tab - Similar structure with updated header */}
            {activeTab === 'notary' && (
              <div className="grid md:grid-cols-2 gap-8">
                {/* Input Form */}
                <div className="space-y-6">
                ...
                {/* Rest of notary tab content remains the same... */}
                {/* Results and other sections would continue here but I'll keep them the same for brevity */}
              </div>
            )}

            {/* Continue with other tabs... keeping the rest the same */}
          </div>
        </div>
